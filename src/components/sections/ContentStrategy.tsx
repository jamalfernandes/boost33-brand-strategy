...
export default function ContentStrategy({ commentCount, onOpenComments }: SectionProps) {
  return (
    <div className="page-inner">
      <div className="page-eyebrow">Section 5 of 7</div>
      <h2 className="page-title">Content strategy</h2>
      <p className="page-sub">Five pillars that every piece of Boost33 content maps to — with the audience need each addresses, formats it works in, and an example angle for each.</p>
      ...
      <div className="cb">
        ...
        <div className="cb-body">
          <p><strong>Standard organic content (Instagram, LinkedIn):</strong> Reviewed by Jamal + Paulina with a 1–2 day turnaround. Blog articles additionally reviewed by Eden. After 30 days of established trust in the content system, a &ldquo;no response in 24h = approved&rdquo; rule for regular organic posts will be proposed to keep the system moving.</p>
          <p><strong>High-stakes content (paid ad launches, product announcements):</strong> Goes to Dezys directly before publish. Separate track, longer lead time required — flagged in advance.</p>
        </div>
      </div>
    </div>
  );
