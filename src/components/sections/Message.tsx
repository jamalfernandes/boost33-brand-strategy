...
export default function Message({ sectionId, commentCount, onOpenComments, acceptances, onAccept }: SectionProps) {
  return (
    <div className="page-inner">
      ...
      <p className="page-sub">The message hierarchy that governs every piece of Boost33 communication — from the core brand statement down to audience-specific language and proof.</p>
