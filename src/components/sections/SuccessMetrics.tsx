...
export default function SuccessMetrics({ commentCount, onOpenComments }: SectionProps) {
  return (
    <div className="page-inner">
      ...
      <p className="page-sub">The north-star target, three sets of key results — one per phase — and how to tell whether the strategy is on track before the lagging numbers are in.</p>
